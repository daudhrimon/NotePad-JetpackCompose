...
import com.daud.notepad.base.network.model.BaseResponse
import com.daud.notepad.base.network.model.GenericError
        ...
        return delegate.enqueue(object : Callback<S> {
            ...
            override fun onResponse(call: Call<S>, response: Response<S>) {
                ...
                if (response.isSuccessful) {
                    ...
                    if (errorBody != null) {
                        if (code == 401 && errorBody is GenericError && errorBody.messages.contains("Authentication failed")) {
